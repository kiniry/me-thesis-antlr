...
public TreeAdaptor getTreeAdaptor() {
    ...
    public final JVMParser.fieldInfo_return fieldInfo() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: bytecodeType, Signature, flags
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
        ...
        try {
            ...
            switch (alt42) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: literals, primitiveType, Constant
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
    ...
    public final JVMParser.staticCtorDefinition_return staticCtorDefinition() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: field_visual_modifier, body, methodInfo
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final JVMParser.ctorDefinition_return ctorDefinition() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: arguments, field_visual_modifier, typeName, methodInfo, afterMethodInfo, throwClause, body, genericDescriptor
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
